      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <Card className="border-none bg-gray-50 dark:bg-[#1a1a1a] p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="pt-4 flex gap-4">
                  ...
                  <Button
                    type="submit"
                    className="flex-1 h-12 bg-[#D51F10] hover:bg-[#b01a0d]"
                    disabled={loading}
                  >
        ...
        {step === "success" && (
          ...
          >
            ...
            <Link to="/">
              <Button className="bg-[#D51F10] hover:bg-[#b01a0d] px-10 h-12">
                Return Home
              </Button>
            </Link>
          </motion.div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 border-t pt-12 dark:border-gray-800">
          <div className="flex items-start gap-4">
            <div className="p-3 bg-gray-50 dark:bg-[#1a1a1a] rounded-xl">
              <Phone className="h-6 w-6 text-[#D51F10]" />
            </div>
            <div>
          ...
          <div className="flex items-start gap-4">
            <div className="p-3 bg-gray-50 dark:bg-[#1a1a1a] rounded-xl">
              <Mail className="h-6 w-6 text-[#D51F10]" />
            </div>
            <div>
          ...
          <div className="flex items-start gap-4">
            <div className="p-3 bg-gray-50 dark:bg-[#1a1a1a] rounded-xl">
              <Clock className="h-6 w-6 text-[#D51F10]" />
            </div>
            <div>

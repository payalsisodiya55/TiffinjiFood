      ...
      <div className="flex flex-col items-center text-center space-y-6 mb-16 relative z-10">
        ...
        >
          <motion.div 
            ...
            className="w-6 h-6 bg-gradient-to-br from-[#D51F10] to-[#b01a0d] rounded-lg flex items-center justify-center shadow-lg"
          >
        ...
        >
          Welcome to <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D51F10] via-[#a64a85] to-[#D51F10] bg-[length:200%_auto] animate-gradient block mt-2">Tiffinji</span>
        </motion.h1>

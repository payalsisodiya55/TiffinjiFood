...
import tiffinLogo from "@/assets/Tiffin_logo.png"
...
export default function AdminSignup() {
  ...
  const [logoUrl, setLogoUrl] = useState(tiffinLogo)
          ...
          <CardHeader className="pb-4">
            <div className="flex w-full items-center gap-4 sm:gap-5">
              <div className="flex h-14 w-28 shrink-0 items-center justify-center rounded-xl bg-gray-900/5 ring-1 ring-neutral-200">
                <img
                  src={logoUrl || tiffinLogo}
                  alt="Logo"
                  className="h-10 w-24 object-contain"
                  loading="lazy"
                  onError={(e) => {
                    // Fallback to default logo if business logo fails to load
                    if (e.target.src !== tiffinLogo) {
                      e.target.src = tiffinLogo
                    }
                  }}
                />
              </div>

        ...
        <div className="rounded-[3rem] border border-slate-200 bg-white p-10 shadow-[0_40px_100px_rgba(15,23,42,0.1)]">
          ...
          <div className="space-y-4">
            {isRejected ? (
              ...
              <Button
                className="h-14 w-full rounded-2xl bg-[#D51F10] text-white font-bold text-base shadow-xl shadow-[#D51F10]/20 hover:bg-[#b01a0d] transition-all active:scale-[0.98]"
                onClick={() => {
                  clearRestaurantPendingPhone()

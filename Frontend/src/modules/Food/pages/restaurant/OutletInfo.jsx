...
const ActionButton = ({ icon: Icon, label, onClick }) => (
  <button 
    onClick={onClick}
    className="w-full flex items-center justify-between p-4 bg-white rounded-2xl border border-gray-100 hover:border-[#D51F10]/30 hover:bg-[#D51F10]/5 transition-all active:scale-[0.98] shadow-sm"
  >
    <div className="flex items-center gap-4">
      <div className="bg-[#D51F10]/5 p-2.5 rounded-xl">
        <Icon className="w-5 h-5 text-[#D51F10]" />
      </div>
        ...
        <div className="bg-white/80 backdrop-blur-md border-b border-gray-100 px-4 py-3 sticky top-0 z-50 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 flex-1">
              <button 
                onClick={goBack} 
                className="p-2 hover:bg-[#D51F10]/5 rounded-xl transition-all active:scale-95"
              >
                <ArrowLeft className="w-5 h-5 text-[#D51F10]" />
              </button>
              <h1 className="text-[17px] font-bold text-gray-900 tracking-tight">Outlet Information</h1>
            </div>
            <div className="bg-[#D51F10]/5 px-3 py-1.5 rounded-full border border-[#D51F10]/10">
              <p className="text-[11px] font-bold text-[#D51F10] uppercase tracking-wider">
            ...
            <div className="relative group">
              <div className="w-24 h-24 rounded-[2rem] bg-white p-1.5 shadow-2xl ring-1 ring-black/5">
                ...
                <button
                  ...
                  disabled={uploadingImage}
                  className="absolute -bottom-1 -right-1 bg-[#D51F10] p-2 rounded-xl text-white shadow-lg shadow-[#D51F10]/30 hover:scale-105 transition-all border-2 border-white active:scale-90"
                >
          ...
          <div className="space-y-4">
            ...
            >
              <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
                <div className="bg-[#D51F10] p-1.5 rounded-lg">
                  <Edit className="w-3 h-3 text-white" />
                </div>
              </div>
              <p className="text-[10px] text-[#D51F10] font-black uppercase tracking-widest mb-1.5 flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 bg-[#D51F10] rounded-full"></span>
                Official Name
              </p>
              <p className="text-lg font-black text-gray-900 group-hover:text-[#D51F10] transition-colors">
            ...
            >
              ...
              <div className="flex items-start gap-3">
                <div className="bg-white p-2 rounded-xl shadow-sm border border-gray-100 shrink-0">
                  <MapPin className="w-5 h-5 text-[#D51F10]" />
                </div>
      ...
      <Dialog open={showEditNameDialog} onOpenChange={setShowEditNameDialog}>
        <DialogContent className="sm:max-w-md p-0 overflow-hidden rounded-[2.5rem] w-[92%] border-none shadow-2xl">
          ...
          <DialogFooter className="p-6 bg-gray-50/50 flex flex-row gap-3">
            ...
            <Button onClick={handleSaveName} disabled={!editNameValue.trim()} className="flex-[2] h-12 bg-[#D51F10] text-white hover:bg-[#b01a0d] rounded-2xl font-bold shadow-lg shadow-[#D51F10]/20 transition-all active:scale-95 disabled:opacity-50">Save Changes</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>

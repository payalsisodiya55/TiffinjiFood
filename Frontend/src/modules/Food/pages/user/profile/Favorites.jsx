    ...
    return (
      ...
      <Card>
          <CardContent className="py-12 text-center">
            ...
            <Link to="/user">
              <Button className="bg-gradient-to-r bg-[#D51F10] hover:opacity-90 text-white">
                Explore Restaurants
              </Button>
            </Link>
          </CardContent>
          ...
          <button
            ...
            className={`px-4 py-2 font-medium transition-colors ${
              activeTab === "restaurants"
                ? "border-b-2 border-[#D51F10] text-[#D51F10]"
              ...
              <Link to={`/user/restaurants/${restaurant.slug}`}>
                <Card className="overflow-hidden h-full">
                  ...
                  <CardContent className="p-3 space-y-2">
                    ...
                    <Button className="w-full bg-gradient-to-r bg-[#D51F10] hover:opacity-90 text-white text-xs py-1.5 h-8">
                      View Restaurant
                          ...
                          <div className="flex items-center justify-between text-xs pt-2 border-t">
                            <div className="flex items-center gap-1">
                              {dish.foodType === "Veg" ? (
                                ...
                                <div className="w-3 h-3 border-2 border-#b01a0d flex items-center justify-center rounded-sm">
                                  <div className="w-1.5 h-1.5 bg-#b01a0d rounded-full"></div>
                                </div>
                              )}
                              <span className="text-muted-foreground font-medium text-xs">{dish.foodType || "N/A"}</span>
                            </div>
                            <div className="text-sm font-bold text-[#D51F10]">

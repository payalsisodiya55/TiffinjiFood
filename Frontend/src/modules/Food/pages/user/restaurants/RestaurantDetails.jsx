      ...
      <AnimatedPage>
        <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
          <div className="flex flex-col items-center gap-4 text-center">
            <AlertCircle className={`h-12 w-12 ${isNetworkError ? 'text-[#D51F10]' : 'text-red-500'}`} />
            <div>
  ...
  return (
    ...
    >
              ...
              <div className="flex items-center gap-2 flex-1 max-w-md">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-2 rounded-full border border-gray-200 dark:border-gray-800 shadow-sm bg-white dark:bg-[#1a1a1a] text-sm dark:text-white focus:outline-none focus:ring-2 focus:ring-[#D51F10] focus:border-transparent"
                    autoFocus
                    onBlur={() => {
                      if (!searchQuery) {
                        setShowSearch(false)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-4 sm:py-5 md:py-6 lg:py-8 space-y-3 md:space-y-4 lg:space-y-5 pb-0">
          ...
          <div className="relative">
            <div className="relative rounded-3xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-[#1a1a1a] shadow-[0_16px_40px_rgba(15,23,42,0.08)] p-4 sm:p-5 space-y-4 overflow-hidden">
              <div className="absolute inset-x-0 top-0 h-1.5 bg-gradient-to-r from-[#D51F10] via-[#8a4b77] to-[#b36b8f]" />
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 whitespace-nowrap rounded-full border px-3 py-1.5 text-sm font-semibold transition-colors ${
                      selectedMenuCategory === "all"
                        ? "border-[#D51F10] bg-[#D51F1015] text-[#D51F10]"
                      ...
                      {sectionItems.map((item) => {
                        ...
                        return (
                          <div
                            ...
                            className={`flex gap-4 p-4 border-b border-gray-100 dark:border-gray-800 last:border-none relative cursor-pointer transition-all duration-300 ${highlightedDishId === item.id ? "bg-[#D51F1005] ring-2 ring-[#D51F10] ring-inset dark:bg-[#D51F1010]" : ""}`}
                              ...
                              {isRecommendedItem(item) && (
                                <div className="flex items-center gap-2 mt-1">
                                  <div className="h-1.5 w-16 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                    <div className="h-full bg-[#D51F10] w-3/4"></div>
                                  </div>
                            ...
                            <div className="relative w-32 h-32 flex-shrink-0">
                              ...
                              {quantity > 0 ? (
                                <motion.div
                                  ...
                                  className={`absolute -bottom-2 left-1/2 -translate-x-1/2 bg-[#D51F10] text-white font-bold px-4 py-1.5 rounded-lg shadow-md flex items-center gap-1 ${shouldShowGrayscale
                                ...
                                <motion.button
                                  ...
                                  disabled={shouldShowGrayscale}
                                  className={`absolute -bottom-2 left-1/2 -translate-x-1/2 bg-[#D51F10] text-white font-bold px-6 py-1.5 rounded-lg shadow-md flex items-center gap-1 transition-all ${shouldShowGrayscale
                                    ? 'bg-gray-300 border-gray-300 text-gray-400 cursor-not-allowed opacity-50'
                                    : 'hover:bg-[#b01a0d] hover:scale-105 active:scale-95'
                                    }`}
                                >
                                      ...
                                      <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center gap-2 mb-1">
                                          {isVeg ? (
                                            ...
                                            <div className="w-4 h-4 border-2 border-[#D51F10] flex items-center justify-center rounded-sm flex-shrink-0">
                                              <div className="w-2 h-2 bg-[#D51F10] rounded-full"></div>
                                            </div>
                                          )}
                                          {item.isSpicy && <span className="text-xs font-semibold text-red-500">Spicy</span>}
                                        </div>
                                        ...
                                        {quantity > 0 ? (
                                          <motion.div
                                            ...
                                            className={`absolute -bottom-2 left-1/2 -translate-x-1/2 bg-white border font-bold px-4 py-1.5 rounded-lg shadow-md flex items-center gap-1 ${shouldShowGrayscale
                                              ...
                                              : 'border-[#D51F10] text-[#D51F10] hover:bg-[#D51F1005]'
                                              }`}
                                          >
                                            <button
                                              onClick={(e) => {
                                              ...
                                              disabled={shouldShowGrayscale}
                                              className={shouldShowGrayscale ? 'text-gray-400 cursor-not-allowed' : 'text-[#D51F10] hover:text-[#b01a0d]'}
                                            >
                                              <Minus size={14} />
                                            </button>
                                          ...
                                          <motion.button
                                            ...
                                            className={`absolute -bottom-2 left-1/2 -translate-x-1/2 bg-white border font-bold px-6 py-1.5 rounded-lg shadow-md flex items-center gap-1 transition-colors ${shouldShowGrayscale
                                              ? 'border-gray-300 text-gray-400 cursor-not-allowed opacity-50'
                                              : 'border-[#D51F10] text-[#D51F10] hover:bg-magenta-50/10'
                                              }`}
                                          >
                                            ADD <Plus size={14} className="stroke-[3px]" />
                                          </motion.button>
      ...
      {!showFilterSheet && !showMenuSheet && !showMenuOptionsSheet && (
        ...
        >
          <Button
            className="bg-[#D51F10] hover:bg-[#b01a0d] text-white flex items-center gap-2 shadow-[0_12px_40px_rgba(213,31,16,0.4)] border border-white/20 px-6 py-3.5 h-auto rounded-full font-bold transform transition-all duration-300 active:scale-95 group"
            size="lg"
              ...
              <>
                ...
                >
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-4 bg-white dark:bg-[#1a1a1a]">
                    <Button
                      className="w-full bg-[#D51F10] hover:bg-[#b01a0d] text-white border-0 flex items-center justify-center gap-2 py-6 rounded-xl font-bold transition-all shadow-lg text-sm"
                      onClick={() => setShowMenuSheet(false)}
                    >
                      <X className="h-4 w-4" />
                      Close
              ...
              <>
                ...
                >
                    ...
                    <div className="space-y-2">
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2.5 rounded-lg border-2 transition-all w-full ${filters.highlyReordered
                          ? "border-[#D51F10] dark:border-[#D51F10] bg-[#F9F9FB] dark:bg-[#D51F10]/20 text-[#D51F10] dark:text-[#D51F10]"
                          : "border-gray-200 dark:border-gray-700 bg-white dark:bg-[#2a2a2a] text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600"
                          }`}
                      >
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-3 flex items-center justify-between bg-white dark:bg-[#1a1a1a]">
                    ...
                    <Button
                      className="bg-[#D51F10] hover:bg-[#b01a0d] text-white px-6 py-2.5 rounded-lg font-bold"
                      onClick={() => setShowFilterSheet(false)}
                    >
                    ...
                    {restaurant?.outlets && Array.isArray(restaurant.outlets) && restaurant.outlets.length > 0 ? (
                      <div className="space-y-2">
                        {restaurant.outlets.map((outlet) => (
                          ...
                          >
                            {outlet?.isNearest && (
                              <div className="flex items-center gap-1.5 mb-2 px-2 py-1 bg-[#F9F9FB] dark:bg-[#D51F10]/20 rounded-md">
                                <Zap className="h-3.5 w-3.5 text-[#D51F10] dark:text-[#D51F10] fill-[#D51F10] dark:fill-[#D51F10]" />
                                <span className="text-xs font-semibold text-[#D51F10] dark:text-[#D51F10]">
              ...
              <>
                ...
                >
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-4">
                    <Button
                      className="w-full bg-[#D51F10] hover:bg-[#b01a0d] text-white py-3 rounded-lg font-bold"
                      onClick={() => {
                        setShowManageCollections(false)
                      }}
                    >

                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  ...
                  {resendTimer > 0 ? (
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="text-primary hover:text-[#b01a0d] font-bold transition-colors disabled:opacity-50"
                    >
                      Resend SMS
                    </button>
                  )}
          ...
          {showNameInput && (
            <div className="space-y-6">
              ...
              <Button
                ...
                disabled={isLoading}
                className="w-full h-12 md:h-14 bg-primary hover:bg-[#b01a0d] text-white font-bold text-lg rounded-xl transition-all hover:shadow-lg active:scale-[0.98]"
              >

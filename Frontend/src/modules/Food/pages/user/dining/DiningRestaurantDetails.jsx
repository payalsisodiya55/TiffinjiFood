  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#f6f7fb]">
        <Loader2 className="h-8 w-8 animate-spin text-[#D51F10]" />
      </div>
    )
  }
        ...
        <div className="relative h-[392px] overflow-hidden">
          ...
          <div className="px-3 pb-1 pt-3">
            <div className="w-full">
              ...
              >
              <Ticket className="h-[15px] w-[15px] text-[#D51F10]" />
            ...
            {topTabs.map((tab) => (
              <button
                ...
                className={`shrink-0 rounded-full border px-4 py-2 text-sm transition-colors ${
                  activeTab === tab.id
                    ? "border-[#D51F10] bg-white dark:bg-slate-900 text-[#2a2018] dark:text-slate-100"
      ...
      <div className="mx-auto max-w-md px-4 pt-4">
        <section id="restaurant-prebook">
          <div>
            ...
            <p className="mt-1 text-[15px] text-[#D51F10] dark:text-purple-400">Limited slots with extra offers</p>
          </div>
        ...
        <section id="restaurant-about" className="mt-5 border-t border-[#e8e8ef] dark:border-slate-800 pt-4">
          ...
          <div className="mt-4 rounded-[18px] border border-[#ececf4] dark:border-slate-800 bg-[#fafbff] dark:bg-slate-900 p-4 transition-colors">
            <div className="space-y-4 text-[14px] text-[#5f6474] dark:text-slate-400">
              ...
              <div className="flex items-start gap-3">
                <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-[#D51F10]" />
                <p>{address}</p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-md">
          <Button
            ...
            className={`h-12 w-full rounded-2xl border text-[17px] font-medium transition-all ${
              isDiningEnabled
                ? "border-[#b18da5] bg-white dark:bg-slate-900 text-[#D51F10] dark:text-purple-400 hover:bg-[#fdfafc] dark:hover:bg-slate-800"
        ...
        <div className="fixed inset-0 z-40">
          ...
          <div className="absolute bottom-0 left-0 right-0 rounded-t-[28px] bg-white dark:bg-slate-900 px-4 pb-6 pt-4 shadow-[0_-20px_60px_rgba(15,23,42,0.18)] border-t border-white/5 transition-colors">
                    ...
                    <button
                      ...
                      className={`relative rounded-2xl border px-3 py-4 text-sm font-bold transition-all ${
                          selectedGuests === count
                            ? "border-[#D51F10] bg-[#fdfafc] dark:bg-purple-950/30 text-[#D51F10] scale-[1.02] shadow-sm"
                            : isBooked
                              ...
                              : isTooLarge
                                ...
                                : "border-[#ece7de] dark:border-slate-800 bg-white dark:bg-slate-800 text-[#23180f] dark:text-slate-100 hover:border-[#D51F10]/30"
                      }`}
                    >
                      {isBooked ? (
            ...
            <Button
              ...
              className="mt-6 h-12 w-full rounded-2xl bg-[#D51F10] text-base font-bold text-white hover:bg-[#b01a0d] disabled:bg-gray-200 disabled:text-gray-400"
            >

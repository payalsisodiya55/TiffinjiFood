    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] pb-10">
        ...
        <div className="flex items-center justify-center py-20">
          <Loader2 className="w-8 h-8 text-[#D51F10] animate-spin" />
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] pb-10">
        ...
        <div className="px-4 py-8 text-center text-gray-600 dark:text-gray-400">
          ...
          <Link to="/user">
            <button className="mt-4 text-[#D51F10] font-medium">Start Ordering</button>
          </Link>
        </div>
      </div>
    )
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] pb-10 font-sans">
      ...
      <div className="p-4 bg-white dark:bg-[#121212] mt-1 border-b dark:border-gray-800">
        <div className="flex items-center bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 rounded-lg px-3 py-2 shadow-sm">
          <Search className="w-5 h-5 text-[#D51F10]" />
          <input
            type="text"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {order.restaurantId && (
                        <Link to={`/user/restaurants/${order.restaurantId}`}>
                          <button className="text-xs text-[#D51F10] font-medium flex items-center mt-1 hover:text-[#b01a0d]">
                ...
                <div className="px-4 py-2 flex items-center justify-between">
                  ...
                  <div className="flex items-center ml-4">
                    <Link to={(isDelivered || isCancelled) ? `/user/orders/${order.id}/details` : `/user/orders/${order.id}`}>
                      <button className="text-xs text-[#D51F10] font-medium hover:text-[#b01a0d] flex items-center gap-1">
                        View Details
                ...
                <div className="px-4 py-3 flex items-center justify-between">
                  ...
                  {isRestaurantCancelled ? (
                    ...
                    <div>
                      ...
                      <button
                        ...
                        className="text-xs text-[#D51F10] font-medium mt-0.5 flex items-center"
                      >
                    ...
                    <div>
                      ...
                      {countdowns[order.id] && countdowns[order.id] > 0 && (
                        <div className="flex items-center gap-1 mt-1 text-xs text-[#D51F10] font-medium">
                          <Clock size={12} />
                  ...
                  {isDelivered && !paymentFailed && (
                    <button
                      ...
                      className="bg-[#D51F10] hover:bg-[#b01a0d] text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-1 shadow-sm transition-colors"
                    >
      ...
      <div className="flex justify-center mt-8 mb-4">
        <h1 className="text-4xl font-black text-gray-200 dark:text-gray-800 tracking-tighter italic uppercase">Tiffinji</h1>
      </div>
      ...
      {ratingModal.open && ratingModal.order && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4 animate-in fade-in duration-200">
          <div className="w-full max-w-md rounded-3xl bg-white dark:bg-[#121212] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 border dark:border-gray-800">
            ...
            <div className="bg-gradient-to-r from-[#D51F10] to-[#b01a0d] px-6 py-5">
            ...
            <div className="px-6 py-6 font-sans">
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border-2 border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1a1a1a] px-4 py-2 text-sm text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#D51F10] focus:border-[#D51F10] resize-none transition-all"
              ...
              <button
                ...
                className="w-full rounded-xl bg-gradient-to-r from-[#D51F10] to-[#b01a0d] text-white text-base font-bold py-3.5 hover:from-[#b01a0d] hover:to-[#C44409] disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-[#D51F10]/30 flex items-center justify-center gap-2"
              >
                {submittingRating ? (
                  <>
            ...
            <div className="px-5 py-5 space-y-3 font-sans">
              {typeof navigator !== "undefined" && navigator.share && (
                <button
                  ...
                  className="w-full rounded-2xl bg-[#D51F10] px-4 py-3 text-sm font-semibold text-white flex items-center justify-center gap-2 hover:bg-[#b01a0d] transition-colors"
                >

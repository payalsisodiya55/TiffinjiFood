    ...
    <div className={`relative min-h-screen bg-white dark:bg-[#0a0a0a] ${shouldShowGrayscale ? 'grayscale opacity-75' : ''}`}>
      ...
      >
        ...
        {bannerImages.length === 0 && !loadingBanner && (
          <div className="absolute top-0 left-0 right-0 bottom-0 z-0 bg-gradient-to-br from-[#fcf4f9] to-[#f5e8f1] dark:from-[#3c0f3d] dark:to-[#b01a0d] overflow-hidden" />
        )}
      </div>
        ...
        <section className="space-y-1 sm:space-y-1.5">
          ...
          >
            ...
            <div className="flex-shrink-0 cursor-pointer" onClick={() => setActiveCategory(null)}>
              ...
              >
                <div className={`w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full overflow-hidden shadow-md transition-all flex items-center justify-center bg-white ${!activeCategory ? 'ring-2 ring-[#D51F10] ring-offset-2' : ''}`}>
                   <div className={`w-full h-full flex items-center justify-center ${!activeCategory ? 'bg-[#D51F10]/10 text-[#D51F10]' : 'bg-gray-50 text-gray-400'}`}>
                      <UtensilsCrossed className="w-6 h-6 sm:w-10 sm:h-10 md:w-12 md:h-12" />
                   </div>
                </div>
                <span className={`text-xs sm:text-sm md:text-base font-semibold text-gray-800 dark:text-gray-200 text-center pb-1 ${!activeCategory ? 'text-[#D51F10]' : ''}`}>
                  All
                </span>
              </motion.div>
            </div>
              ...
              return (
                <div key={category.id} className="flex-shrink-0 cursor-pointer" onClick={() => setActiveCategory(isActive ? null : category.id)}>
                    <motion.div
                      ...
                      transition={{ type: "spring", stiffness: 300, damping: 20 }}
                    >
                      <div className={`w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full overflow-hidden shadow-md transition-all ${isActive ? 'ring-2 ring-[#D51F10] ring-offset-2' : ''}`}>
                        <OptimizedImage
                          src={category.image}
                          alt={category.name}
                      ...
                      <span className={`text-xs sm:text-sm md:text-base font-semibold text-gray-800 dark:text-gray-200 text-center pb-1 ${isActive ? 'text-[#D51F10]' : ''}`}>
                                ...
                                {quantity > 0 ? (
                                  <Link to="/user/cart" onClick={(e) => e.stopPropagation()}>
                                    <Button
                                      variant={"ghost"}
                                      size="sm"
                                      className="bg-[#D51F10] text-white hover:bg-[#b01a0d] h-7 md:h-8 lg:h-9 px-3 md:px-4 lg:px-5 text-xs md:text-sm lg:text-base font-bold shadow-md transition-all active:scale-95"
                                    >
                                      View cart
                                    </Button>
                                  </Link>
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 md:px-6 py-4 md:py-5 border-b dark:border-gray-800">
                ...
                <button
                  ...
                  className="text-[#D51F10] dark:text-[#b18da5] font-medium text-sm md:text-base"
                >
                  Clear all
                </button>
              </div>
                  ...
                  {sortOptions.map((option) => (
                    <button
                      ...
                      className={`px-4 md:px-5 lg:px-6 py-3 md:py-4 rounded-xl border text-left transition-colors ${draftSelectedSort === option.id
                        ? 'border-[#D51F10] bg-[#fdfafc] dark:bg-[#D51F10]/20'
                        : 'border-gray-200 dark:border-gray-800 hover:border-[#D51F10]'
                        }`}
                    >
                      <span className={`text-sm md:text-base lg:text-lg font-medium ${draftSelectedSort === option.id ? 'text-[#D51F10] dark:text-[#b18da5]' : 'text-gray-700 dark:text-gray-300'}`}>
                        {option.label}
                      </span>
                    </button>
                  ))}
              ...
              <div className="flex items-center gap-4 md:gap-6 px-4 md:px-6 py-4 md:py-5 border-t dark:border-gray-800 bg-white dark:bg-[#1a1a1a]">
                ...
                <button
                  onClick={handleApply}
                  className="flex-1 py-3 md:py-4 font-semibold rounded-xl transition-colors text-sm md:text-base bg-[#D51F10] text-white hover:bg-[#b01a0d]"
                >
                  Apply
                </button>
              </div>
                ...
                {selectedItem.customisable && (
                  <div className="flex items-center gap-2 mb-4">
                    <div className="flex-1 h-0.5 bg-gray-200 rounded-full overflow-hidden">
                      <div className="h-full bg-[#D51F10]" style={{ width: '50%' }} />
                    </div>
                ...
                <div className="flex items-center gap-4 md:gap-5 lg:gap-6">
                  ...
                  <Button
                    className={`flex-1 h-[44px] md:h-[50px] lg:h-[56px] rounded-lg md:rounded-xl font-semibold flex items-center justify-center gap-2 text-sm md:text-base lg:text-lg ${shouldShowGrayscale
                      ...
                      : 'bg-[#D51F10] hover:bg-[#b01a0d] dark:bg-[#D51F10] dark:hover:bg-[#b01a0d] text-white'
                      }`}
                    onClick={(e) => {
                      if (!shouldShowGrayscale) {
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <button
                    ...
                    className="rounded-2xl border border-gray-200 dark:border-gray-700 px-4 py-3 text-sm font-medium text-gray-800 dark:text-gray-200 hover:border-[#D51F10] hover:text-[#D51F10] transition-colors"
                  >
                    {option.label}
                  </button>
                ))}

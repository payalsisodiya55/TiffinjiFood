      ...
      >
        ...
        >
          ...
          <button 
             ...
             className="absolute top-2 right-2 p-1.5 rounded-full bg-orange-50/80 text-orange-400 hover:text-#b01a0d hover:bg-orange-100/80 transition-colors z-20 shadow-sm"
          >
          ...
          <div className="flex items-center gap-4 relative z-10 w-full">
            ...
            <div className="bg-gradient-to-br from-[#D51F10] to-[#D94E0A] shadow-lg shadow-[#D51F10]/20 rounded-xl px-4 py-2 shrink-0 flex flex-col items-center justify-center border border-orange-200">
